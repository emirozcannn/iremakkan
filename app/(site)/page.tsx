...
export default async function Home() {
  ...
  return (
    <>
      ...
      {/* Ultra-Modern "Neden İrem AKKAN" Section */}
          ...
          <AnimatedSection>
            ...
            <div className="space-y-10 mb-16">
              ...
              <p className="text-xl md:text-2xl text-white/80 max-w-4xl mx-auto leading-relaxed">
                Psikolojik danışmanlık sürecinde size sunduğum profesyonel değerler ve yaklaşımlar
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
              {[
                ...
                <div key={i} className="group relative">
                  <div className="absolute -inset-2 bg-gradient-to-r from-gold/20 to-teal/20 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 blur-lg"></div>
                  <div className="relative bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 hover:border-gold/40 shadow-2xl hover:shadow-gold/20 transition-all duration-500 hover:-translate-y-2">
                    <div className="flex flex-col items-center text-center">
                      <div className="w-16 h-16 bg-gradient-to-br from-gold/30 to-teal/30 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
