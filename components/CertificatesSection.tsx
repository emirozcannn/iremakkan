...
const CertificatesSection: React.FC<CertificatesSectionProps> = ({ certificates, labels }) => {
            ...
            >
              ...
              <div className="relative bg-white/15 backdrop-blur-xl border border-white/25 rounded-2xl overflow-hidden shadow-xl hover:shadow-gold/20 transition-all duration-500 group-hover:scale-[1.02] group-hover:-translate-y-1 h-full flex flex-col">
                {cert.image && (
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <Image
                      ...
                      alt={cert.image.alt || cert.title || "Sertifika"}
                      fill
                ...
                <div className="p-6 flex-grow">
                  {cert.title && (
                    <h3 className="text-lg font-bold text-navy mb-3 font-display leading-tight">
                      {cert.title}
                    </h3>
                  )}
                  ...
                  <div className="space-y-2">
                    {cert.institution && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-navy/80 text-sm font-medium">{cert.institution}</span>
                      </div>
                    )}
                    ...
                    {cert.year && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-navy/60 text-sm">{cert.year}</span>
                      </div>
                    )}
                  </div>
                </div>
